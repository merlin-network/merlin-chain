...
// source: merlin/mint/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgBurnTokens)(nil), "merlin.mint.v1beta1.MsgBurnTokens")
	proto.RegisterType((*MsgBurnTokensResponse)(nil), "merlin.mint.v1beta1.MsgBurnTokensResponse")
}

func init() { proto.RegisterFile("merlin/mint/v1beta1/tx.proto", fileDescriptor_05381ca08ac023c4) }
...
func (c *msgClient) BurnTokens(ctx context.Context, in *MsgBurnTokens, opts ...grpc.CallOption) (*MsgBurnTokensResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlin.mint.v1beta1.Msg/BurnTokens", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_BurnTokens_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlin.mint.v1beta1.Msg/BurnTokens",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "merlin.mint.v1beta1.Msg",
	...
	Metadata: "merlin/mint/v1beta1/tx.proto",
}
