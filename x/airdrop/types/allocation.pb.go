...
// source: merlin/airdrop/v1beta1/allocation.proto
...
func init() {
	proto.RegisterType((*AirdropAllocation)(nil), "merlin.airdrop.v1beta1.AirdropAllocation")
}

func init() {
	proto.RegisterFile("merlin/airdrop/v1beta1/allocation.proto", fileDescriptor_45865675d34b2451)
}
